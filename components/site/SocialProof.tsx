      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          ...
          <h2 className="mt-5 text-4xl font-semibold tracking-tight sm:text-5xl">
            Built for people who want a city life, not another feed.
          </h2>
        </div>
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          ...
          <Card className="bg-[color:rgba(255,245,231,0.92)]">
            ...
            <p className="mt-3 text-base leading-7 text-[color:rgba(37,34,30,0.72)]">
              Curated choice without decision overload, built around neighborhoods people actually want to visit.
            </p>
          </Card>
          <Card className="bg-[color:rgba(237,244,248,0.92)]">
            <p className="text-4xl font-semibold tracking-tight">2x</p>
            <p className="mt-3 text-base leading-7 text-[color:rgba(37,34,30,0.72)]">
              The system is designed so repeated interaction does the social work that swiping never could.
            </p>
          </Card>
        </div>
      </div>

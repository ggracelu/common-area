...
export function WallySection() {
  return (
    <section id="wally" className="px-6 py-16 sm:px-8 lg:px-10 lg:py-24">
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.7fr_1.3fr] lg:items-center">
        <Card className="relative overflow-hidden bg-[linear-gradient(180deg,rgba(191,90,54,0.96),rgba(136,58,37,0.96))] text-[var(--color-background)]">
          ...
          <div className="relative flex min-h-[300px] flex-col justify-between">
            ...
            <p className="max-w-xs text-lg leading-8">
        ...
        <div>
          <Badge>Meet Wally</Badge>
          <h2 className="mt-5 text-4xl font-semibold tracking-tight sm:text-5xl">
            Playful, chaotic, warm. Never careless.
          </h2>
          <p className="mt-5 max-w-3xl text-lg leading-8 text-[color:rgba(37,34,30,0.74)]">
            Wally gives WhyNot its social confidence. The tone should feel local, funny, and
            encouraging without becoming childish or unserious. Wally makes leaving the house
            sound appealing. The product still treats trust, safety, payments, and privacy like
            adult responsibilities.
          </p>
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <Card className="bg-white/72">
              <h3 className="text-xl font-semibold">What Wally adds</h3>
              <p className="mt-3 text-base leading-7 text-[color:rgba(37,34,30,0.72)]">
                Charm, momentum, neighborhood energy, and a reason for the brand to feel remembered.
              </p>
            </Card>
            <Card className="bg-white/72">
              <h3 className="text-xl font-semibold">What Wally never replaces</h3>
              <p className="mt-3 text-base leading-7 text-[color:rgba(37,34,30,0.72)]">
                Clear product rules, operational trust, accessible design, and credible onboarding.
              </p>
            </Card>
          </div>
        </div>

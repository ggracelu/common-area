    ...
    <div className={`v16-crumbs ${reduced ? "v16-crumbs-static" : ""}`} aria-label="Crumbs the Cat, pixel mascot">
      ...
      >
        ...
        <g className="v16-pose v16-pose-lick" filter="url(#v16Shadow)">
          <rect x="18" y="18" width="28" height="16" rx="2" fill="#cfcfcf" />
          <rect x="22" y="12" width="20" height="12" rx="2" fill="#d9d9d9" />
          <rect x="22" y="10" width="4" height="4" fill="#d9d9d9" />
          <rect x="38" y="10" width="4" height="4" fill="#d9d9d9" />
          <rect x="26" y="16" width="4" height="4" fill="#0a0a0a" />
          <rect x="34" y="16" width="4" height="4" fill="#0a0a0a" />
          <rect x="30" y="20" width="4" height="2" fill="#0a0a0a" />
          <rect x="30" y="22" width="4" height="2" fill="#ff3b2e" />
          {/* Paw up */}
          <g className="v16-paw">
            <rect x="42" y="22" width="6" height="6" rx="1" fill="#d9d9d9" />
            <rect x="44" y="24" width="2" height="2" fill="#0a0a0a" opacity="0.22" />
          </g>
          {/* Tail */}
          <g className="v16-tail">
            <rect x="14" y="24" width="6" height="4" rx="1" fill="#cfcfcf" />
            <rect x="10" y="26" width="6" height="4" rx="1" fill="#cfcfcf" />
          </g>
        </g>

        {/* Pose B: curled up */}
        <g className="v16-pose v16-pose-curl" filter="url(#v16Shadow)">
          <rect x="18" y="18" width="28" height="18" rx="6" fill="#d9d9d9" />
          <rect x="24" y="14" width="16" height="10" rx="5" fill="#e2e2e2" />
          <rect x="27" y="17" width="3" height="2" fill="#0a0a0a" opacity="0.6" />
          <rect x="34" y="17" width="3" height="2" fill="#0a0a0a" opacity="0.6" />
          <rect x="31" y="20" width="2" height="2" fill="#0a0a0a" opacity="0.65" />
          {/* Tail wraps */}
          <rect x="16" y="24" width="8" height="6" rx="3" fill="#cfcfcf" />
        </g>

        {/* Pose C: nap (long loaf) */}
        <g className="v16-pose v16-pose-nap" filter="url(#v16Shadow)">
          <rect x="12" y="22" width="40" height="12" rx="6" fill="#d9d9d9" />
          <rect x="20" y="16" width="16" height="10" rx="5" fill="#e2e2e2" />
          <rect x="23" y="19" width="3" height="1.5" fill="#0a0a0a" opacity="0.55" />
          <rect x="30" y="19" width="3" height="1.5" fill="#0a0a0a" opacity="0.55" />
          <rect x="27" y="21.5" width="2" height="1.5" fill="#0a0a0a" opacity="0.55" />
